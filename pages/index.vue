<template>
  <div class="max-width-1160px my-6 py-3 ">
    ...
    <div class="columns mt-5 is-vcentered mx-0" data-aos="fade-right"
     data-aos-offset="300"
    ...
    <div class="columns is-vcentered mt-6 has-text-centered-mobile mx-0"data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
      <div class="column is-5 px-5">
...
.img-background-shadow-black {
  background-image: url('/siman3333.png'); /* مسیر تصویر */
  background-size: cover; /* تصویر تمام فضای پس‌زمینه را پوشش می‌دهد */
  background-position: center; /* موقعیت تصویر را وسط چین می‌کند */
  padding: 20px;
